...
describe("GET --> /calculateage", () => {
  it("should return correct age in format of date birth 28-10-1983 and current date 03-10-2022 and status code 200", async () => {
  ...
  it("should return correct age in format of date birth 28-10-1983 and current date 04-10-2022 and status code 200", async () => {
  ...
  it("should return correct age in format of date birth 13-11-1982 and current date 03-10-2022 and status code 200", async () => {
  ...
  it("should return correct age in format of date birth 13-11-1982 and new date 04-10-2022 status code 200", async () => {
    let dateOfBirth = "13-11-1982";
    let requestBody = { currentDate: "2022-10-04" };
    let res = await request(app).get(`/calculateage/${dateOfBirth}`).send(requestBody);
